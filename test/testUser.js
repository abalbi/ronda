...
function getLoginAdminAgent(callback) {
  ...
  describe('users', function() {
    describe('auth',function(){
      it('should get access_token from login', function(done){
        getLoginAdminAgent(function(adminagent) {
          agent = adminagent
          ...
          .end(function(e,res){
            ...
            agent.get( baseurl + '/mail_verification/' + res.body.mail_verification_token)
              .send( {} )
              .end(function(e, res){
                agent.post( baseurl + '/login')
                  .send( {
